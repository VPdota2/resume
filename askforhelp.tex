...
\begin{itemize}
  \item Use Python to do data summary for Hospital Cost and Utilization Project (HCUP) data in XX (2011–16) (critical illness patients percentile, 
  \item Use JMP to do categorical data analysis for variables' effect on critical illness 
\end{itemize}
