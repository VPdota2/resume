...
\datedsubsection{\textbf{XXXXXXXXXXXXXXXXXXXX}, XXXXXXX, U.S.}{2018 -- Present}
\textit{Ph.D.} in Statistics, expected May 2021
\datedsubsection{\textbf{XXXXXXXXXXXXXXXXXXXX}, XXXXXXX, U.S.}{2016 -- 2018}
\textit{Master of Science} in Statistics
\datedsubsection{\textbf{XXXXXXX University},XXXXXX, China}{2011 -- 2015}
...
\begin{itemize}
 \item Using Bayesian method (variationsl inference, etc.) to add variability on the parameters of deep neural network, and build 'confidence interval' like what we have done in statistic model. 
...
\role{Second Author}{Collabrate with XXXXXX XXXXXXXX}
Accepted by Critical Care Medicine: January 2019 - Volume 47 - Issue 1 - p 38
\begin{itemize}
\item Use Python to do data summary for Hospital Cost and Utilization Project (HCUP) data in KY (2011–16). (critical illness patients percentile, icu beds summary, etc.)
...
\role{Second Author}{Collabrate with XXXX XXX}
...
\{Collabrate with XXXXXXXXX XXXX and XXXX XXXX}{}
