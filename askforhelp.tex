...
\begin{itemize}
  \item Using Bayesian method to add variability on the parameters of deep neural networks, such as CNN and GAN models, and build 'confidence interval' like what we have done in statistic model. 
