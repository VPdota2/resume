...
\begin{itemize}
  \item Use JMP on HCUP data in KY to apply hypothesis test on data, Visulized data and showed significance. 
...
\begin{itemize}
  ...
  \item Use Matlab to implement Isomap, LIsomap, LLE, Laplacian Eigenmaps and Hessian LLE to do dimensional reduction on COIL20 data, and compare result with PCA and KPCA, while classification method is LDA, QDA and kNN, find that PCA is best(0.7 classification rate) in dimensional reduction (others only 0.4).
