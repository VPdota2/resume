...
\begin{itemize}
 \item Using Bayesian method (variationsl inference, etc.) to add variability on the parameters of deep neural networks and build 'confidence interval' like what we have done in statistic model. 
